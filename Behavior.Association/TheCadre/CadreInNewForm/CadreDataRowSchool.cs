...
namespace JHSchool.Association
{
    class CadreDataRowSchool : System.ComponentModel.INotifyPropertyChanged
    {
                    ...
                    if (!string.IsNullOrEmpty(_student_seat_no))
                    {
                        ...
                        else
                        {
                            ...
                            else
                            {
                                ...
                                _CadreRecord.ReferenceType = "社團幹部"; //本功能寫死為班級幹部記錄
        ...
        private AssociationByClassSeanNo _Context { get; set; }
        ...
        /// 未傳入任何參數
        /// </summary>
        public CadreDataRowSchool(string CadreName, int index, AssociationByClassSeanNo Context, int DefSchoolYear, int DefSemester)
        {
        ...
        public CadreDataRowSchool(Srecord stud, SchoolObject obj, int index, AssociationByClassSeanNo Context, int DefSchoolYear, int DefSemester)
        {
            _DefSchoolYear = DefSchoolYear;
            _DefSemester = DefSemester;
